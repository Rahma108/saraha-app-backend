...
const uploader = multer({
  dest: resolve("./upload/user/image/covers")
});
...
router.patch(
    ...
    async (req, res, next) => {
        ...
        const files = req.files.coverProfilePicture; // 👈 مهم

        const account = await coverPicture(files, req.user);
