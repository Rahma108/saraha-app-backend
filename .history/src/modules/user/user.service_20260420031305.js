...
import { BadRequestException, compareHash, ConflictException, decrypt, generateHash } from '../../common/utils/index.js';
...
export const removeProfilePicture = async(file , user )=>{
    //Upload Profile Picture API
    if (!user.profilePicture) {
        throw BadRequestException("User ")
